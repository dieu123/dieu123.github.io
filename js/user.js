 $(function(){
   ...
   $('.listmenu1 li:nth-child(4)').click(function () {
    ...
    $('.listmenu1 li:nth-child(1)').click(function () {
        $('body,html').animate({scrollTop:$('#gioithieu').offset().top},1000,"easeInOutQuad");
        return false;
    });
    $('.listmenu1 li:nth-child(2)').click(function () {
        $('body,html').animate({scrollTop:$('#doitac').offset().top},1200,"easeInOutQuad");
        return false;
    });
    $('.listmenu1 li:nth-child(3)').click(function () {
        $('body,html').animate({scrollTop:$('#tintuc').offset().top},1500,"easeInOutQuad");
        return false;
    });
    $('.listmenu1 li:nth-child(5)').click(function () {
        $('body,html').animate({scrollTop:$('#sanpham').offset().top},1500,"easeInOutQuad");
        return false;
    });
    $('.listmenu1 li:nth-child(7)').click(function () {
        $('body,html').animate({scrollTop:$('#lienhe').offset().top},1500,"easeInOutQuad");
        return false;
    });
